...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
    ...
    <div>
        ...
        <select name="instansi_id" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
    ...
    <div>
        ...
        <select name="role" required class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
    ...
    <div>
        ...
        <select name="level_akses" required class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
