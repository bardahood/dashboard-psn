@php
    // Struktur 4-tab konsolidasi mengikuti paparan resmi "Update Project
    // Profile" (Struktur Project Profile: Gambaran Umum, Perencanaan,
    // Penjabaran Tahunan) ditambah Upload Dokumen -- menggantikan tab-tab
    // terpisah per sub-resource (RO, Risiko, Indikator, dst) yang
    // sebelumnya masing-masing punya route sendiri. Trisula BUKAN tab
    // tersendiri (catatan koreksi: dicek ulang terhadap Project Profile) --
    // target tahunannya ada di tab Perencanaan, target triwulanannya di tab
    // Penjabaran, sesuai pembagian resmi pada paparan. Dipertahankan sinkron
