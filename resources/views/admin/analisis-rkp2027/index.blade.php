    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-4">
            ...
            @else
                ...
                <div class="bg-white shadow-sm ring-1 ring-gray-950/5 rounded-xl p-4 flex items-center justify-between gap-4">
                    ...
                    <form method="POST" action="{{ route('admin.analisis-rkp2027.terapkan') }}" onsubmit="return confirm('Terapkan kategori Carryover ke {{ $jumlahBelumBerkategori }} PSN?');">
                        @csrf
                        <button type="submit" class="rounded-lg bg-blue-800 text-white shadow-sm hover:shadow transition-all text-sm font-medium px-4 py-2 hover:bg-blue-700 whitespace-nowrap" @disabled($jumlahBelumBerkategori === 0)>
