<div class="bg-white shadow-sm ring-1 ring-gray-950/5 rounded-xl p-6">
    ...
    <form wire:submit="saveUsulan" class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div class="sm:col-span-2">
            ...
            <textarea wire:model="usulan.nama_usulan_psn" rows="2" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm"></textarea>
        ...
        <div>
            ...
            <input type="text" wire:model="usulan.nomor_kode_usulan" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
        </div>
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Tanggal Kunjungan <span class="text-red-500">*</span></label>
            <input type="date" wire:model="usulan.tanggal_kunjungan" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
        ...
        <div>
            ...
            <select wire:model="usulan.klaster_id" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
        ...
        <div>
            ...
            <select wire:model="usulan.provinsi_id" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
        ...
        <div>
            ...
            <select wire:model="usulan.pengusul_instansi_id" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
        ...
        <div>
            ...
            <select wire:model.live="usulan.jenis_pengusul" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
        ...
        <div>
            ...
            <input type="text" wire:model="usulan.lokasi_detail" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
        </div>
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Indikasi Pendanaan</label>
            <input type="text" wire:model="usulan.indikasi_pendanaan" placeholder="APBN/APBD/BUMN/Swasta/KPBU" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
        </div>

        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Nilai Proyek (Rp)</label>
            <input type="number" step="0.01" wire:model="usulan.nilai_proyek_rp" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
        </div>
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Verifikator</label>
            <select wire:model="usulan.verifikator_id" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
        ...
        <div class="sm:col-span-2">
            ...
            <input type="text" wire:model="usulan.kpu_terkait" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
        </div>
        ...
        <div>
            ...
            <select wire:model="usulan.psn_id" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
