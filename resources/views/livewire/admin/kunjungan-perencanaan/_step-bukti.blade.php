<div class="space-y-6">
    <div class="bg-white shadow rounded-lg p-6">
        ...
        <form wire:submit="addBukti" class="grid grid-cols-1 sm:grid-cols-4 gap-3">
            <div>
                ...
                <input type="text" wire:model="buktiForm.id_bukti" placeholder="mis. KL-K4-001" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">
            </div>
            <div>
                <label class="block text-xs text-gray-500 mb-1">Kriteria Terkait</label>
                <input type="text" wire:model="buktiForm.kriteria_terkait" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">
            </div>
            <div class="sm:col-span-2">
                <label class="block text-xs text-gray-500 mb-1">Nama Dokumen</label>
                <input type="text" wire:model="buktiForm.nama_dokumen" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">
            </div>
            <div>
                <label class="block text-xs text-gray-500 mb-1">Pemilik Data</label>
                <input type="text" wire:model="buktiForm.pemilik_data" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">
            </div>
            <div>
                <label class="block text-xs text-gray-500 mb-1">Lokasi Bukti</label>
                <input type="text" wire:model="buktiForm.lokasi_bukti" placeholder="halaman/foto/koordinat" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">
            </div>
            <div>
                <label class="block text-xs text-gray-500 mb-1">Status Verifikasi</label>
                <select wire:model="buktiForm.status_verifikasi" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">
            ...
            <div class="sm:col-span-2">
                ...
                <input type="text" wire:model="buktiForm.simpulan_singkat" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">
            </div>
            <div class="sm:col-span-2">
                <label class="block text-xs text-gray-500 mb-1">Tindak Lanjut</label>
                <input type="text" wire:model="buktiForm.tindak_lanjut" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">
            </div>
    ...
    <div class="flex justify-between">
        ...
        <button wire:click="goToStep(10)" class="rounded-md bg-blue-800 text-white px-4 py-2 text-sm hover:bg-blue-700">Lanjut ke Kesimpulan &rarr;</button>
    </div>
</div>
