        ...
        @foreach ($dokumenTeknisList as $dokumen)
            <div class="border rounded-md p-4 grid grid-cols-1 sm:grid-cols-4 gap-3">
                ...
                <div>
                    ...
                    <select wire:model="dokumenTeknisJawaban.{{ $dokumen->id }}.tersedia" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
                ...
                <div>
                    ...
                    <input type="text" wire:model="dokumenTeknisJawaban.{{ $dokumen->id }}.tanggal_versi_dokumen" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
                </div>
                <div>
                    <label class="block text-xs text-gray-500 mb-1">Kesesuaian Kondisi Lapangan</label>
                    <input type="text" wire:model="dokumenTeknisJawaban.{{ $dokumen->id }}.kesesuaian_kondisi_lapangan" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
                </div>
                <div>
                    <label class="block text-xs text-gray-500 mb-1">Catatan</label>
                    <input type="text" wire:model="dokumenTeknisJawaban.{{ $dokumen->id }}.catatan" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
                </div>
            </div>
        @endforeach
