<div class="bg-white shadow-sm ring-1 ring-gray-950/5 rounded-xl p-6">
    ...
    <form wire:submit="savePmo" class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
            ...
            <select wire:model="pmo.hasil_pmo_rpjmn_program_prioritas" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
        ...
        <div>
            ...
            <select wire:model="pmo.hasil_pmo_rpjmn_phtc" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
                <option value="">-- Pilih --</option>
                <option value="Ya">Ya</option>
                <option value="Tidak">Tidak</option>
            </select>
        ...
        <div>
            ...
            <select wire:model="pmo.hasil_pmo_selesai_2029" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
                <option value="">-- Pilih --</option>
                <option value="Ya">Ya</option>
                <option value="Tidak">Tidak</option>
            </select>
        ...
        <div>
            ...
            <input type="text" wire:model="pmo.skor_pmo_sementara" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
        </div>
        <div class="sm:col-span-2">
            <label class="block text-sm font-medium text-gray-700 mb-1">Status Keputusan Saat Ini</label>
            <input type="text" wire:model="pmo.status_keputusan_saat_ini" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
        </div>
        <div class="sm:col-span-2">
            <label class="block text-sm font-medium text-gray-700 mb-1">Catatan Pembahasan PMO</label>
            <textarea wire:model="pmo.catatan_pembahasan_pmo" rows="3" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm"></textarea>
        </div>
