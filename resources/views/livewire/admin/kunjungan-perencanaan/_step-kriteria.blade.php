                    ...
                    <div class="space-y-4">
                        @foreach ($terlihat as $kriteria)
                            <div class="border-t pt-4 first:border-t-0 first:pt-0">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                    <div>
                                        ...
                                        @if ($kriteria->tipe_penilaian === 'YaTidak')
                                            <input type="text" wire:model="kriteriaJawaban.{{ $kriteria->id }}.klaim_atau_temuan_dokumen" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
                                        @else
                                            <select wire:model="kriteriaJawaban.{{ $kriteria->id }}.nilai_desk_review_pmo" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" wire:model="kriteriaJawaban.{{ $kriteria->id }}.temuan_lapangan" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
                                    </div>
                                    <div>
                                        <label class="block text-xs text-gray-500 mb-1">Nilai Hasil Verifikasi</label>
                                        @if ($kriteria->tipe_penilaian === 'YaTidak')
                                            <select wire:model="kriteriaJawaban.{{ $kriteria->id }}.nilai_hasil_verifikasi" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
                                                <option value="">-- Pilih --</option>
                                ...
                                <div class="mt-2">
                                    <input type="text" wire:model="kriteriaJawaban.{{ $kriteria->id }}.catatan" placeholder="Catatan (opsional)" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-xs">
                                </div>
                            </div>
                        @endforeach
                    </div>
