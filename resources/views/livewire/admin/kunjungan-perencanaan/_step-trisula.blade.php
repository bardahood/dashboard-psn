            ...
            <div class="border rounded-md p-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        ...
                        <input type="text" wire:model="trisulaJawaban.{{ $dampak->id }}.indikator_klaim_dokumen" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">
                    </div>
                    <div>
                        <label class="block text-xs text-gray-500 mb-1">Temuan Lapangan (Spot-check)</label>
                        <input type="text" wire:model="trisulaJawaban.{{ $dampak->id }}.temuan_lapangan_spotcheck" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">
                    </div>
                    <div>
                        <label class="block text-xs text-gray-500 mb-1">Kondisi Awal Terverifikasi?</label>
                        <select wire:model="trisulaJawaban.{{ $dampak->id }}.kondisi_awal_terverifikasi" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">
                    ...
                    <div>
                        ...
                        <select wire:model="trisulaJawaban.{{ $dampak->id }}.atribusi_masuk_akal" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">
                            <option value="">-- Pilih --</option>
                            <option value="Ya">Ya</option>
                            <option value="Sebagian">Sebagian</option>
                            <option value="Tidak">Tidak</option>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" wire:model="trisulaJawaban.{{ $dampak->id }}.catatan" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">
                    </div>
                </div>
            </div>
        @endforeach
