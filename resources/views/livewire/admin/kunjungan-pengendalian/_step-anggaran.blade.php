<div class="space-y-6">
    <div class="bg-white shadow rounded-lg p-6">
        ...
        <form wire:submit="addAnggaran" class="grid grid-cols-1 sm:grid-cols-4 gap-3">
            <div class="sm:col-span-2">
                ...
                <select wire:model="anggaranForm.ro_id" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">
            ...
            <div>
                ...
                <input type="number" step="0.01" wire:model="anggaranForm.pembiayaan_rencana_juta_rp" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">
            </div>
            <div>
                <label class="block text-xs text-gray-500 mb-1">Realisasi Klaim (Juta Rp)</label>
                <input type="number" step="0.01" wire:model="anggaranForm.realisasi_anggaran_klaim_juta_rp" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">
            </div>
            <div>
                <label class="block text-xs text-gray-500 mb-1">Realisasi Verifikasi (Juta Rp)</label>
                <input type="number" step="0.01" wire:model="anggaranForm.realisasi_anggaran_verifikasi_juta_rp" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">
            </div>
            <div>
                <label class="block text-xs text-gray-500 mb-1">Bukti Dokumen Tersedia</label>
                <select wire:model="anggaranForm.bukti_dokumen_tersedia" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">
            ...
            <div class="sm:col-span-2">
                ...
                <input type="text" wire:model="anggaranForm.catatan" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">
            </div>
    ...
    <div class="flex justify-between">
        ...
        <button wire:click="goToStep(5)" class="rounded-md bg-blue-800 text-white px-4 py-2 text-sm hover:bg-blue-700">Lanjut ke Bagian E &rarr;</button>
    </div>
</div>
