<div class="bg-white shadow-sm ring-1 ring-gray-950/5 rounded-xl p-6">
    ...
    <form wire:submit="saveEvaluasi" class="space-y-4">
        <div>
            ...
            <textarea wire:model="evaluasi.isu_tantangan" rows="3" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm"></textarea>
        </div>
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Kebutuhan Tindak Lanjut</label>
            <textarea wire:model="evaluasi.kebutuhan_tindak_lanjut" rows="3" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm"></textarea>
        </div>
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Hasil Evaluasi Proyek</label>
            <textarea wire:model="evaluasi.hasil_evaluasi_proyek" rows="3" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm"></textarea>
        </div>
