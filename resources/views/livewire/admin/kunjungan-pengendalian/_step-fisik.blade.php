<div class="space-y-6">
    <div class="bg-white shadow-sm ring-1 ring-gray-950/5 rounded-xl p-6">
        ...
        <form wire:submit="addFisik" class="grid grid-cols-1 sm:grid-cols-4 gap-3">
            <div class="sm:col-span-2">
                ...
                <select wire:model="fisikForm.ro_id" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
            ...
            <div>
                ...
                <input type="number" step="0.01" wire:model="fisikForm.target_periode_ini" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
            </div>
            <div>
                <label class="block text-xs text-gray-500 mb-1">Realisasi Klaim</label>
                <input type="number" step="0.01" wire:model="fisikForm.realisasi_fisik_klaim" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
            </div>
            <div>
                <label class="block text-xs text-gray-500 mb-1">Realisasi Verifikasi</label>
                <input type="number" step="0.01" wire:model="fisikForm.realisasi_fisik_verifikasi" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
            </div>
            <div class="sm:col-span-3">
                <label class="block text-xs text-gray-500 mb-1">Catatan</label>
                <input type="text" wire:model="fisikForm.catatan" class="block w-full rounded-lg border-gray-300 transition-colors shadow-sm text-sm">
            </div>
    ...
    <div class="flex justify-between">
        ...
        <button wire:click="goToStep(4)" class="rounded-lg bg-blue-800 text-white shadow-sm hover:shadow transition-all px-4 py-2 text-sm hover:bg-blue-700">Lanjut ke Bagian D &rarr;</button>
    </div>
</div>
