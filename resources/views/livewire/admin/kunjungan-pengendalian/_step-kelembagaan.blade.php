        ...
        @foreach ($peranList as $peran)
            <div class="border rounded-md p-4 grid grid-cols-1 sm:grid-cols-4 gap-3">
                ...
                <div>
                    ...
                    <select wire:model="kelembagaan.{{ $peran }}.instansi_tercatat_id" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">
                ...
                <div>
                    ...
                    <input type="text" wire:model="kelembagaan.{{ $peran }}.instansi_aktual" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">
                </div>
                <div>
                    <label class="block text-xs text-gray-500 mb-1">Sesuai?</label>
                    <select wire:model="kelembagaan.{{ $peran }}.sesuai" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">
                ...
                <div>
                    ...
                    <input type="text" wire:model="kelembagaan.{{ $peran }}.catatan" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">
                </div>
            </div>
        @endforeach
