<div class="bg-white shadow rounded-lg p-6">
    ...
    <form wire:submit="saveIdentitas" class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
            ...
            @else
                <select wire:model.live="identitas.psn_id" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">
        ...
        <div>
            ...
            <input type="text" wire:model="identitas.status_psn_tercatat" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">
        </div>

        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Tanggal Kunjungan <span class="text-red-500">*</span></label>
            <input type="date" wire:model="identitas.tanggal_kunjungan" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">
        ...
        <div>
            ...
            <input type="text" wire:model="identitas.lokasi_kunjungan" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">
        </div>

        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Verifikator</label>
            <select wire:model="identitas.verifikator_id" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">
        ...
        <div>
            ...
            <select wire:model="identitas.kepatuhan_frekuensi_pelaporan" class="block w-full rounded-md border-gray-300 shadow-sm text-sm">
        ...
        <div class="sm:col-span-2">
            ...
            <textarea wire:model="identitas.tim_verifikator_tambahan" rows="2" class="block w-full rounded-md border-gray-300 shadow-sm text-sm"></textarea>
        </div>
