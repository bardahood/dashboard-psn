...
<div class="space-y-6">
    ...
    <form method="GET" class="bg-white shadow-sm ring-1 ring-gray-950/5 rounded-xl p-4 grid grid-cols-1 sm:grid-cols-4 gap-3">
        ...
        <select name="instansi_id" class="col-span-1 sm:col-span-2 rounded-lg border-gray-300 transition-colors text-sm">
        ...
        <button class="rounded-lg bg-blue-800 text-white shadow-sm hover:shadow transition-all text-sm font-medium py-2 hover:bg-blue-700">Filter</button>
